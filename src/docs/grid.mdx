...
<Container>
  <Row>
    <Col debug xs={2} order={3}>order 3</Col>
    <Col debug xs={2} order={1}>order 1</Col>
  </Row>
</Container>
...
<Container>
  <Row>
    <Col debug xs={2} sm={2} lg={2} order={{ xs: 1, sm: 4, lg: 2 }}>xs=1, sm=4, lg=2</Col>
    <Col debug xs={2} sm={2} lg={2} order={{ xs: 2, sm: 3, lg: 1 }}>xs=2, sm=3, lg=1</Col>
    <Col debug xs={2} sm={2} lg={2} order={{ xs: 3, sm: 2, lg: 4 }}>xs=3, sm=2, lg=4</Col>
    <Col debug xs={2} sm={2} lg={2} order={{ xs: 4, sm: 1, lg: 3 }}>xs=4, sm=1, lg=3</Col>
  </Row>
</Container>
...
With that in mind, if you enter `align={{xs: 'center', lg: 'flex-end'}}`, we'll have ***XS***
to ***MD*** with align set to center and ***LG*** to ***XL*** set to flex-end.
...
> 💡**Tip!** When passed an object, since this grid is mobile-first, if a value is entered for a screen (i.e XS),
the other screens (SM, MD, LG and XL) will inherit these values ​​if not set.
With that in mind, if you enter `justify={{xs: 'center', lg: 'space-between'}}`, we'll have ***XS***
to ***MD*** with justify set to center and ***LG*** to ***XL*** set to space-between.
